...
<html lang="en"> 
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <title>Sign In</title> <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"> 
   <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css"> 
   <link rel="shortcut icon" href="favicon.png" type="image/png"> <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> 
   <style> 
   body { 
            ...
            @keyframes bounce { 
              0%, 80%, 100% { 
                transform: translateY(0); opacity: 0.5; 
                   ...
                   transform: translateY(-14px); opacity: 1; 
                   } 
            } 
            /* Error Overlay */ 
            #error-overlay { 
          ...
          <div class="container"> 
            <div class="row align-items-center min-vh-100"> 
              <div class="col-md-6"> 
                ...
                <p class="intro-text reveal"> Join us to get access to exclusive features, updates, and personalized content. Your data is secure and never shared. </p> 
                <button class="btn filled-btn mt-3"> Learn More </button> 
              </div> 
              <div class="col-md-6 d-flex justify-content-center"> 
                <div class="signin-box p-4 rounded"> 
                  ...
                  <form action="" method="post" id="signinpage"> 
                    ...
                    <div class="signup"> If you Don't have Account? <a href="signup.php">Sign Up</a> </div> 
                </form> 
                </div> 
                </div> 
                </div> 
        ...
        $.ajax({
            ...
            success: function(response){ 
                ...
                if(res === "success") {
                    ...
                    // Redirect admin to OTP verification page
              ...
              let i = 0; window.onload = () => { 
                const heading = document.getElementById("typing-text"); 
                const para = document.querySelector(".reveal"); 
                heading.innerHTML = ""; (function type() { 
                  if (i < text.length) { 
                    heading.innerHTML += text[i++]; setTimeout(type, 80); 
                  } 
                })(); 

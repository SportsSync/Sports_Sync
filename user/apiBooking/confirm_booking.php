...
$slots       = $data['slots']; // array of slot_id
...
try {
  ...
  $sql = "
    ...
    (turf_id, court_id, user_id, booking_date, total_amount, status)
    VALUES ($turf_id, $court_id, $user_id, '$bookingDate', $total, 'confirmed')
  ";
  ...
  echo json_encode(["status"=>"error","msg"=>"Slot already booked"]);
}
